...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RolleUser", b =>
                {
                    b.Property<int>("RolesIdRolle")
                        .HasColumnType("int");

                    b.Property<int>("RolesIdUser")
                        .HasColumnType("int");

                    b.HasKey("RolesIdRolle", "RolesIdUser");

                    b.HasIndex("RolesIdUser");
            ...
            modelBuilder.Entity("RolleUser", b =>
                {
                    b.HasOne("Domain.Models.Rolle", null)
                        .WithMany()
                        .HasForeignKey("RolesIdRolle")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Models.User", null)
                        .WithMany()
                        .HasForeignKey("RolesIdUser")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
